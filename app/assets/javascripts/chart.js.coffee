	...
	if $('#charts').length > 0
		...
		$(document).ready ->
			chart = new Highcharts.Chart({
				...
				xAxis: {
					categories: ['Business Planning', 'Graphic Design', 'Industrial Design', 'Software', 'Research & Development', 'Internal']
				}
				yAxis: {
	                min: 0,
	                title: {
				...
				series: [
					...
					}
					{
						...
						data: [0,0,0,0,0,$('#business_units_graph').data('internal-count')]
						color: '#dfa60d'
					}
